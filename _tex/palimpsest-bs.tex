...
\begin{tcolorbox}[enhanced jigsaw, colback=white, left=2mm, titlerule=0mm, breakable, bottomrule=.15mm, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacityback=0, toptitle=1mm, opacitybacktitle=0.6, toprule=.15mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white]
